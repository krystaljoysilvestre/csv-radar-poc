...
| ------------------------------------------- | ------ | ---- | -------- | ----------------------------------------------------------------------------- |
| DOE site                                    | Failed | 403  | 517ms    | HTTP attempts: 1; robots.txt fetched; Possible anti-bot response detected     |
| ERC site                                    | Failed | 403  | 273ms    | HTTP attempts: 1; robots.txt fetched; Possible anti-bot response detected     |
| Google News: Philippines Energy Policy host | OK     | 200  | 1641ms   | HTTP attempts: 1; robots.txt has crawl constraints; Basic HTML request worked |
